...
export const getUserDashboard = async(req, res, next) => {
    try {
        ...
        const avgCaloriesBurntPerWorkout = totalCaloriesBurnt.legth > 0 ? totalCaloriesBurnt[0].totalCaloriesBurnt / totalWorkouts : 0;

        // Fetch categoires of workouts
        ...
        // Format category date for pie CharacterData
